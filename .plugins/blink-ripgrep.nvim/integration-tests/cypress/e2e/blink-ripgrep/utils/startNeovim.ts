...
const nvimAppNameSchema = z.enum(["nvim", "nvim_blink_nightly"] satisfies MyNeovimAppName[])

export function startNeovim(opts: MyStartNeovimServerArguments = {}): Cypress.Chainable<NeovimContext> {
