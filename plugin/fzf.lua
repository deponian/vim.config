...
require'fzf-lua'.setup({
  ...
  winopts = {
    ...
    hl = {
      ...
      preview_border = 'FloatBorder',   -- preview border color
      ...
      title          = 'SignColumn',        -- preview border title (file/buffer)
      ...
      scrollborder_f = 'Delimiter',   -- scrollbar "full" section highlight
    },
    preview = {
